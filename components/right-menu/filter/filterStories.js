	...
	return (
		<div className='flex flex-col text-sm space-y-4 border-2 border-gray-100 rounded-md divide-y-2 divide-gray-100'>
			<div className='flex items-center font-medium pl-5 pt-5'>
				...
				<p className='ml-1.5'>Sort Stories Board</p>
			</div>
			<div className='grid gap-y-4 pl-5 pt-5 pb-5'>
				<button className='group flex items-center text-left text-gray-400'>
					<span className='group-hover:text-black'>👀 Latest</span>
					<span>
						<svg
							xmlns='http://www.w3.org/2000/svg'
				...
				{openDropdown === true && <DropdownLabelMenu type='tag' />}
			</div>
		</div>
	);
}
